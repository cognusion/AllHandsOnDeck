...
var noneTest []string = strings.Split(`2137 : /sbin/dhclient -q -lf /var/lib/dhclient/dhclient-eth0.leases -pf /var/run/dhclient-eth0.pid eth0 
...
`, "\n")
var dTest []string = strings.Split(`26068 : /usr/bin/mongod -f /etc/mongod2.conf 
...
var simpleList []string = strings.Split("hello,world,this,is,a,test", ",")
var complexList []string = []string{"hello world", "this is a test", "of some, cool features, of this function", "called makeList"}
